...
var BaseKernel = require("./base-kernel").BaseKernel;

class SquaredExponentialKernel extends BaseKernel {
...
module.exports.SquaredExponentialKernel = SquaredExponentialKernel;